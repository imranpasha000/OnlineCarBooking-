package com.boxcars.notification.config;
...
public class RabbitConfig {
    ...
    @Bean
    public Binding allEventsBinding(Queue notificationEventsQueue, TopicExchange boxcarsExchange) {
        return BindingBuilder.bind(notificationEventsQueue).to(boxcarsExchange).with("#");
    }
